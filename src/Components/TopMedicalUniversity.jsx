                  ...
                  <Row className="m-2">
                    <Col md={12}>
                      <p className="text-justify py-md-2">
                        Here you will get all the Medical Universities of USA,
                        Ukraine, Georgia, Kyrgyzstan, Poland, Kazakhstan,
                        Russia, Philippines. We are all known that almost 80% of
                        Indian Medical Students are interested to complete there
                        MBBS dream.
                      </p>
                      <p className="text-justify py-md-2">
                        Get all the Medical University list with there fees
                        structure. Feel Free to contact us for free counselling
                        and also we will clear your all the doubts regarding
                        MBBS in Abroad.
                      </p>
                      <p className="text-justify py-md-2">
                        Top Medical Universities to Study MBBS in USA, MBBS in
                        Ukraine, MBBS in Kyrgyzstan, MBBS in Georgia, MBBS in
                        Russia and MBBS in Philippines. Glow Overseas Education
                        recommends the below Mentioned Medical Universities to
                    ...
                    <Col md={12}>
                      ...
                      <table className="table table-hover table-bordered">
                        ...
                        <tbody>
                          <tr>
                            <td scope="row">
                              American University of Barbados <br /> Duration:
                              9years
                            </td>
                          </tr>
                          <tr>
