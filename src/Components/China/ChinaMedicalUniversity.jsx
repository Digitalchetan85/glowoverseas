                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="../mbbs-in-china.php">MBBS in China</a></li>
                              <li className="breadcrumb-item active" aria-current="page">China Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">China Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        China Medical University one of the top Medical University in China.
                                        </p>
                                        <ul>
                                ...
                                <div className="col-md-6">
                                    <div className="text-center">
                                        <img src="../images/mbbs-in-china/medical-universities/black-sea-national-medical-university.jpg" alt="" className="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="study-china mb-2">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="pb-2">
                                        <h4 className="text-center pt-2 pb-2">MBBS in China</h4>
                                        <img src="./images/mbbs-in-China-flag.jpg.png" alt="" className="img-fluid rounded-circle ml-3">
                                        <p className="p-2 text-justify">
                                            China is one of the safest countries in the world. China is the topmost country to study MBBS in Abroad for Indian students compared to other countries like China, China, USA, Russia, Philippines, Kazakhstan. Many of Indian students already studying in the Top Medical Universities in China. China Medical Universities are approved by MCI / WHO.
                                        </p>
                                        <p className="p-2 text-justify">
                        ...
                        <div className="b-china-image">
                            <div className="m-2">
                                <div className="row">
                                    <div className="col-md-12">
                                        <h2 className="text-center"><u>About China</u></h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <div className="">
                                            ...
                                            <p className="text-white">Beijing - Capital of China</p>
                                            <p className="text-white">Language spoken - Mandarin, English</p>
                                            <p className="text-white">National currency is Chinese Yuan. 1 USD = 0.15, Chinese Yuan(01/01/2010)</p>
                                        </div>
                                        <div className="china-map">
                                            <p className="text-white text-center">Population – 139,77 million<br>
                                                Territory – 95,96,960 sq. km</p>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-4">
                                        <div className="pt-1 pb-1">
                                            ...
                                            <p className="text-white">China in religious geography lies on the boundaries separating Roman Catholic, Eastern Orthodox and Islamic spheres of influence.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Education system</h5>
                                            <p className="text-white">Unlike many other European countries higher education in China is comparatively cost effective.It is indeed, recommended for anyone seeking for quality and affordable education abroad.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Armenia at Kharkiv National Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                    ...
                                    <div className="university">
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Dalian Medical University</h5>
                                                        <img src="./images/mbbs-in-Ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Dalian Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                            <a href="./mbbs-in-china/dalian-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Fujian Medical University</h5>
                                                        <img src="./images/mbbs-in-Ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Fujian Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                            <a href="./mbbs-in-china/fujian-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Jilin Medical University</h5>
                                                        <img src="./images/mbbs-in-Ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Jilin Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                            <a href="./mbbs-in-china/jilin-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Kunming Medical University</h5>
                                                        <img src="./images/mbbs-in-Ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Kunming Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                            <a href="./mbbs-in-china/kunming-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Nanjing Medical University</h5>
                                                        <img src="./images/mbbs-in-Ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Nanjing Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                            <a href="./mbbs-in-china/nanjing-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="col-md-6">
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="university">
                                                    ...
                                                    <div className="">
                                                        <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                        <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="university">
                                                    ...
                                                    <div className="">
                                                        <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                        <a href="./mbbs-in-armenia.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="m-1 pt-2 pb-2 medical-university">
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="university">
                                                    <h5 className="pt-2 pb-2 text-center">Study MBBS in Egypt</h5>
                                                    <img src="../images/mbbs-in-ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                    <p className="pt-2 pb-2 text-justify">
                                                        Lorem ipsum dolor sit aliquam suscipit? Saepe unde consequuntur rem, corporis ipsum quidem ea harum obcaecati, perspiciatis, placeat doloremque perferendis dolorum numquam aspernatur nisi ullam?
                                                    </p>
                                                    <div className="">
                                                        <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                        <a href="./mbbs-in-egypt.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="m-1 pt-2 pb-2 medical-university">
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="university">
                                                    <h5 className="pt-2 pb-2 text-center">Study MBBS in China</h5>
                                                    <img src="../images/mbbs-in-ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                    <p className="pt-2 pb-2 text-justify">
                                                        Lorem ipsum dolor sit aliquam suscipit? Saepe unde consequuntur rem, corporis ipsum quidem ea harum obcaecati, perspiciatis, placeat doloremque perferendis dolorum numquam aspernatur nisi ullam?
                                                    </p>
                                                    <div className="">
                                                        <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                        <a href="./mbbs-in-china.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="m-1 pt-2 pb-2 medical-university">
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="university">
                                                    <h5 className="pt-2 pb-2 text-center">Study MBBS in Bangladesh</h5>
                                                    <img src="../images/mbbs-in-ukraine/medical-universities/oo-bogomolets-national-medical-university.jpg" alt="" className="img-fluid">
                                                    <p className="pt-2 pb-2 text-justify">
                                                        Lorem ipsum dolor sit aliquam suscipit? Saepe unde consequuntur rem, corporis ipsum quidem ea harum obcaecati, perspiciatis, placeat doloremque perferendis dolorum numquam aspernatur nisi ullam?
                                                    </p>
                                                    <div className="">
                                                        <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                        <a href="./mbbs-in-bangladesh.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default ChinaMedicalUniversity