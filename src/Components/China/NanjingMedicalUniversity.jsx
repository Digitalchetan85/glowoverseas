...
import Img1 from "../../Images/mbbs-in-china/medical-universities/Nanjing.png";
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="/mbbs-in-china">MBBS in China</a></li>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="pb-2">
                        ...
                        <div className="text-center">
                          <a href="/" className="pt-2 pb-2 btn btn-warning m-2">
