...
const NanjingMedicalUniversity = () => {
  return (
    <>
<div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="/">MBBS in China</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Nanjing Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Nanjing Medical University</h3>
                                </div>
                            </div>
                                    ...
                                    <div className="university">
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">China Medical University</h5>
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            China Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <a href="/" className="pt-2 pb-2 btn btn-warning m-2 float-left">Book Now</a>
                                                            <a href="./mbbs-in-china/china-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
export default NanjingMedicalUniversity