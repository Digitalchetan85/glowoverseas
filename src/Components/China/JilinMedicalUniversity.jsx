...
import Img1 from "../../Images/mbbs-in-china/medical-universities/jilin.png";
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Jilin Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
            ...
            <div className="col-md-8">
              <div className="container">
                <div className="border p-2 m-1">
                  <div className="row">
                    <div className="col-md-12">
                      <h3 className="text-center">Jilin Medical University</h3>
                    </div>
                  </div>
...
export default JilinMedicalUniversity