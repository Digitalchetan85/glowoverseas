                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Emilio Aguinaldo College of Medicine</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Emilio Aguinaldo College of Medicine</h3>
                                </div>
                            </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        <p className="text-justify pb-2">
                                            Emilio Aguinaldo College of Medicine was founded and established by Dr. Paulo C. Campos, who is a National Scientist in Nuclear Medicine for students who wanted to study MBBS. On July 23 with 24 enrolees, it was formally opened and Dr. Salvador R. Salcedo, an ophthalmologist became the first Dean from 2001 to 2003, followed by a gastroenterologist, Dr. Esteban P. Pineda from 2003 to 2010, then a surgical oncologist, Dr. Conrado C. Cajucom from 2010 to 2013 and the fourth and present Dean is Dr. Asuncion L. Abaya-Morido, a general surgeon and the former Hospital Director of Medical Centre Manila, now known as the Manila Med.
                                        </p>
                                        <ul>
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Philippines at Emilio Aguinaldo College of Medicine an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
...
export default EmilioAguinaldoCollege