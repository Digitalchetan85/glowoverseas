                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Emilio Aguinaldo College of Medicine was founded and
                          established by Dr. Paulo C. Campos, who is a National
                          Scientist in Nuclear Medicine for students who wanted
                          to study MBBS. On July 23 with 24 enrolees, it was
                          formally opened and Dr. Salvador R. Salcedo, an
                          ophthalmologist became the first Dean from 2001 to
                          2003, followed by a gastroenterologist, Dr. Esteban P.
                          Pineda from 2003 to 2010, then a surgical oncologist,
                          Dr. Conrado C. Cajucom from 2010 to 2013 and the
                          fourth and present Dean is Dr. Asuncion L.
                          Abaya-Morido, a general surgeon and the former
                          Hospital Director of Medical Centre Manila, now known
                          as the Manila Med.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Philippines at Emilio Aguinaldo College
                          of Medicine an affordable cost. Fell free to talk to
