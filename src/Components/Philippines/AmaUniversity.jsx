...
const AmaUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Ama University | MBBS in Philippines | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-philippines/ama-university"
        />
        <meta
          name="description"
          content="MBBS in Ama University is the best place to Study MBBS in Philippines. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
