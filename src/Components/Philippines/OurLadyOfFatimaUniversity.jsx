                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Our Lady of Fatima University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Our Lady of Fatima University</h3>
                                </div>
                            </div>
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Philippines at Our Lady of Fatima University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                            ...
                            <div className="row pt-5">
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            In Our Lady of Fatima University provides a quality hostel facility with security cameras and also Internet Facilities are available. Separate Indian hostel facilities also available who are booking your seat at the earliest. Hostel to College will be a reachable distance between 1 to 2km.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="university">
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">AMA University</h5>
                                                        <img src="../images/mbbs-in-philippines/medical-universities/ama-school-of-medicine.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            AMA University is one of the top Medical University in Philippines. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-philippines/ama-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
