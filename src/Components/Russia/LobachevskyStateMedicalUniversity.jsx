...
const LobachevskyStateMedicalUniversity = () => {
  return (
    <div>
        <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="/">MBBS in Russia</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Mari Lobachevsky State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Lobachevsky State Medical University</h3>
                                </div>
                            </div>
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Russia at Mari State Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                    ...
                                    <div className="university">
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Kazan Federal University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/kazan-federal-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Kazan Federal University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/kazan-federal-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <img src="../images/mbbs-in-russia/medical-universities/bashkir-state-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Bashkir State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
...
export default LobachevskStateMedicalUniversity