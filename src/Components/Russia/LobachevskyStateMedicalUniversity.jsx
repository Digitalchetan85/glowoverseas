...
import img1 from "../../Images/mbbs-in-russia/medical-universities/lobachevsky.png";
...
const LobachevskyStateMedicalUniversity = () => {
  ...
  return (
    <div>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Lobachevsky State Medical University | MBBS in Russia | GOE</title>
        <link rel="canonical" href="https://glowoverseas.com/mbbs-in-russia/lobachevsky-state-Medical-University" />
        <meta
          name="description"
          content="MBBS in Lobachevsky State Medical University is the best place to Study MBBS in Russia. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          State University is considered to be a classical
                          university of El Republic. The University was founded
                          in the year 1972. The University is the member of the
                          Volga Region’s Association of classical universities,
                          a member of the Russian Association of Classical
                          Universities and the establisher of the Association of
                          Finno-Ugric Universities. This University is one of
                          the most influential and effective multi-field
                          universities of the Volga Federal District and Russia.
                          State University plays a significant role in the
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at State Medical University an
...
export default LobachevskyStateMedicalUniversity;
