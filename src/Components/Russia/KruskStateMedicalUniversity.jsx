...
import img1 from "../../Images/mbbs-in-russia/medical-universities/kursk-state-medical-university.png";
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Kursk State Medical University is a Russian medical
                          university located in Kursk, western Russia,
