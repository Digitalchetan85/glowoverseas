...
import img1 from "../../Images/mbbs-in-russia/medical-universities/kabardino-balkarian-state-university.png";
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Kabardino-Balkarian State University; Russian: public
                          research university located in Nalchik,
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at Kabardino Balkarian State
