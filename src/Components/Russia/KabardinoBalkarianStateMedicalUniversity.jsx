...
const KabardinoBalkarianStateMedicalUniversity = () => {
  return (
    <>
<div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Kabardino Balkarian State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Kabardino Balkarian State Medical University</h3>
                                </div>
                            </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        <p className="text-justify pb-2">
                                            Kabardino-Balkarian State University; Russian: public research university located in Nalchik, Kabardino-Balkaria, Russia
                                        </p>
                                        <ul>
                                            <li>Established in 1966.</li>
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Russia at Kabardino Balkarian State Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Crimea State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/crimea-state-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Crimea State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
...
export default KabardinoBalkarianStateMedicalUniversity