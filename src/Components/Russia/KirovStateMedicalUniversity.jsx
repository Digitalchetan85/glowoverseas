...
import img1 from "../../Images/mbbs-in-russia/medical-universities/kirov.png";
...
const KirovStateMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Kirov State Medical University | MBBS in Russia | GOE</title>
        <link rel="canonical" href="https://glowoverseas.com/mbbs-in-russia/kirov-state-medical-university" />
        <meta
          name="description"
          content="MBBS in  Kirov State Medical University is the best place to Study MBBS in Russia. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Kazan State Medical University is a Russian medical
                          university located in Kazan, western Russia,
                          established in 1935. In 1994 it was granted university
                          status.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at Krusk State Medical University
