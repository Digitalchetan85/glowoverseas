                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Kirov State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Kirov State Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Kazan State Medical University is a Russian medical university located in Kazan, western Russia, established in 1935. In 1994 it was granted university status.
                                        </p>
                                        <ul>
                                ...
                                <div className="col-md-6">
                                    <div className="text-center">
                                        <img src="../images/mbbs-in-ukraine/medical-universities/black-sea-national-medical-university.jpg" alt="" className="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Russia at Krusk State Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <?php include '../templates/university-free-councelling.php' ?>
                                        </div>
