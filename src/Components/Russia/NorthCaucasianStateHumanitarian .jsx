...
import img1 from "../../Images/mbbs-in-russia/medical-universities/caucasian.png";
...
const NorthCaucasianStateHumanitarian = () => {
  ...
  return (
    <div>
      <Helmet>
        <meta charSet="utf-8" />
        <title> North Caucasian State Humanitarian | MBBS in Russia | GOE</title>
        <link rel="canonical" href="https://glowoverseas.com/mbbs-in-russia/north-caucasian-state-humanitarian" />
        <meta
          name="description"
          content="MBBS in North Caucasian State Humanitarian is the best place to Study MBBS in Russia. Call Us for Free Counselling"
        />
</Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Moscow State University is a public research
                          university located in Moscow, Russia. It was founded
                          in 1755 by Mikhail Lomonosov. During the Soviet
                          period, MSU was renamed after Lomonosov in 1940 and
                          was then known as Lomonosov University. Its current
                          rector is Viktor Sadovnichiy.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at Moscow University an
...
export default NorthCaucasianStateHumanitarian;
