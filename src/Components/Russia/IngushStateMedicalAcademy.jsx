...
import img1 from "../../Images/mbbs-in-russia/medical-universities/ingush.png";
...
const IngushStateMedicalAcademy = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Ingush State Medical Academy | MBBS in Russia | GOE</title>
        <link rel="canonical" href="https://glowoverseas.com/mbbs-in-russia/ingush-state-medical-academy" />
        <meta
          name="description"
          content="MBBS in Ingush State Medical Academy is the best place to Study MBBS in Russia. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Ingush State Medical Academy; Russian: public research
                          university located in Nalchik, Kabardino-Balkaria,
                          Russia
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at Ingush State Medical Academy
