...
import img1 from "../../Images/mbbs-in-russia/medical-universities/crimea-state-medical-university.png";
...
const CrimeaStateMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Crimea State Medical University | MBBS in Russia | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-russia/crimea-state-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Crimea State Medical University is the best place to Study MBBS in Russia. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Crimea State Medical University one of the top Medical
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at Crimea State Medical
