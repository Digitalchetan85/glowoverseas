                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="../mbbs-in-russia.php">MBBS in Russia</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Kazan Federal University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Kazan Federal University</h3>
                                </div>
                            </div>
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Kazan State Medical University In the fields of medicine, Kazan State Medical University is considered to be one of the most esteemed Universities of Russia. From this University, thousands of Indians had been graduated in the past. For higher learning in medicine, KSMU is treated to be the multifunctional and multi-levelled government institution. In getting hands on education in medicine, it meets both personal and social needs in developing biomedical and clinical sciences, as well as broadening scientific knowledge of medical sciences.
                                        </p>
                                        <ul>
                                ...
                                <div className="col-md-6">
                                    <div className="text-center">
                                        <img src="../images/mbbs-in-russia/medical-universities/kazan-federal-university.png" alt="" className="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="study-russia mb-2">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="pb-2">
                                        <h4 className="text-center pt-2 pb-2">MBBS in Russia</h4>
                                        <img src="../images/mbbs-in-russia-flag.jpg.png" alt="" className="img-fluid rounded-circle ml-3">
                                        <p className="p-2 text-justify">
                                            Russian Medical Universities happens to be one of the most advanced ones for it uses well-equipped teaching methods and streamlined techniques for the development of students in chosen specialties. Over the period of time, Russia has become a popular destination for medical studies because of the teaching standards and low fee. That’s because the medical education in Russia is subsidized by the Russian government up to 70% which makes the fees of Russian medical colleges lower than other countries.
                                        </p>
                                        <div className="text-center">
                        ...
                        <div className="b-russia-image">
                            <div className="m-2">
                                <div className="row">
                                    <div className="col-md-12">
                                        <h2 className="text-center"><u>About Russia</u></h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <div className="">
                                            ...
                                            <p className="text-white">Moscow - Capital of Russia</p>
                                            <p className="text-white">Language spoken - Russian and English</p>
                                            <p className="text-white">National currency is Russian Rubble. 1 USD = 75.96 Rubble</p>
                                        </div>
                                        <div className="russia-map">
                                            <p className="text-white text-center">Population – 14.44 Crores<br>
                                                Territory – 17,125,191 sq. km</p>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-4">
                                        <div className="pt-1 pb-1">
                                            ...
                                            <p className="text-white">Russia in religious geography lies on the boundaries separating Roman Catholic, Eastern Orthodox and Islamic spheres of influence.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Education system</h5>
                                            <p className="text-white">Unlike many other European countries higher education in Russia is comparatively cost effective.It is indeed, recommended for anyone seeking for quality and affordable education abroad.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Major cities</h5>
                                            <p className="text-white">Moscow, Saint Petersburg, Novosibirsk, Yekaterinburg</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="top-medical-university pt-5 pb-5">
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Russia at Kazan Federal University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            Many students and parents are doubting whether Indian food is available or not. In Russia surely we get Indian food. Indian Restaurants are available. So students can easily concentrate on his studies rather than thinking about Food.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            In Russian Medical Universities provides a quality hostel facility with security cameras and also Internet Facilities are available. Separate Indian hostel facilities also available who are booking your seat at the earliest. Hostel to College will be a reachable distance between 1 to 2km.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="row pt-5">
                                <div className="col-md-12">
                                    <div className="university">
                                        <h5 className="text-center pb-5">Admission Process for MBBS in Russia</h5>
                                        <div className="text-center">
                            ...
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        <h4 className="text-center">Other Top Medical Universities in Russia</h4>
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Crimea State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/crimea-state-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Crimea State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/crimea-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Kabardino Balkarian State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/kabardino-balkarian-state-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Kabardino Balkarian State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/kabardino-balkarian-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Bashkir State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/bashkir-state-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                        ...
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/bashkir-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Kuban State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/kuban-state-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Kuban State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/kuban-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Krusk State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/kursk-state-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Krusk State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/krusk-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Mari State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/mari-state-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Mari State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/mari-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Moscow University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/moscow-state-university-of-medicine-and-dentistry-named-after-a.i.-evdokimov.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Moscow University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="./mbbs-in-russia/moscow-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Samara State Medical University</h5>
                                                        <img src="../images/mbbs-in-russia/medical-universities/samara-state-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Samara State Medical University is one of the top Medical University in Russia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-russia/samara-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
