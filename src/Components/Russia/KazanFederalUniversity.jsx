...
const KazanFederalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Kazan Federal University | MBBS in Russia | GOE</title>
        <link rel="canonical" href="https://glowoverseas.com/mbbs-in-russia/kazan-federal-university" />
        <meta
          name="description"
          content="MBBS in Kazan Federal University is the best place to Study MBBS in Russia. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
