...
import img1 from "../../Images/mbbs-in-russia/medical-universities/volgograd.png";
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Samara State Medical University one of the top Medical
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Russia at Volgograd State Medical
