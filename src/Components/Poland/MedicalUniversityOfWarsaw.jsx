...
import Gdnsk from "../../Images/mbbs-in-poland/medical-universities/medical-university-of-gdansk.png";
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="/mbbs-in-poland">MBBS in Poland</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Medical University of Warsaw</li>
                            </ol>
                          </nav>
                    </div>
                </div>
              ...
              <div className="container">
                  ...
                  <div className="row pt-2">
                    <div className="col-md-6">
                      ...
                      <p className="text-justify pb-2">
                                            The Medical University of Warsaw is one of the oldest and the largest medical school in Poland. The first academic department of medicine was created in 1809. It is one of the most prestigious schools of medical science affiliated with a number of large hospitals in Poland, The Medical University of Warsaw is one of the oldest universities in Poland established in the year of 1809. The university has been training a number of medical professionals in the field of medical and pharmaceutical sciences. English division at the Medical University of Warsaw was founded in the year of 1993 for the students who want to study medicine in English.
                                        </p>
                                        <p className="text-justify pb-2">
                                            At the Medical University of Warsaw, theoretical as well as practical knowledge of students checked by conducting the tests in every month. The university has 70 departments which provide knowledge of basic science and premedical training in the form of lectures, seminars, practical classes to students.
                                        </p>
                                        <p className="text-justify pb-2">
                                            Also, the university has affiliated hospitals to ensure high-quality clinical training. The university provides highly-experienced teaching staff who worked as a researcher or medical practitioner at the university’s preclinical and clinical departments.
                                        </p>
                                        <ul>
                                            <li>Established in 1809.</li>
                ...
                <div className="study-poland mb-2">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="pb-2">
                        <h4 className="text-center pt-2 pb-2">MBBS in Poland</h4>
                                        ...
                                        <p className="p-2 text-justify">
                                            Since 2010, Poland has become the best choice for Indian students for pursuing MBBS abroad due to high quality of medical education, low tuition fee’s structure & high growth rate after completing MBBS in Poland.
                                        </p>
                                        <p className="p-2 text-justify">
                                        ...
                                        <h2 className="pt-2 pb-2 text-center">Why Should You Choose for MBBS in Poland?</h2>
                                        <ul className="pt-2 pb-2">
                                            <li>Listed in world directory of medical colleges.</li>
                                            <li>Top Universities facilitates students with high quality of education system.</li>
                                            <li>The fee structure of MBBS courses in Poland is affordable.</li>
                                            <li>One Year Internship with quality government & private hospitals.</li>
                                            <li>All the medical colleges in the Poland follow English medium of instruction.</li>
                                            <li>The medical colleges of Poland are very popular due to their highly experienced staff in the field of medicine.</li>
                                            <li>The Poland medical degree is a globally recognized degree.</li>
                                            <li>Poland offers a blue card work permit for students who have completed their MBBS degree so that they can get a job and settle down as well in this country.</li>
                                            <li>All medical universities in Poland are recognized and approved by international bodies such as WHO & NMC.</li>
                                            <li>It is easier to get admission for PG after MBBS in Poland in comparison to get admission in India for PG.</li>
                                        </ul>
                        <div className="text-center">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="pt-1 pb-1">
                          ...
                          <p className="text-white">
                            Poland in religious geography lies on the
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        Study MBBS in Poland at Medical University of Gdansk affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                        </p>
                        <div className="text-center">
                          {/* <<?php include '../templates/university-free-councelling.php' ?> */}
                        </div>
                    ...
                    <div className="col-md-12">
                      <div className="university">
                        <h4 className="text-center">
                          Other Top Medical Universities in Kazaksthan
                        </h4>
                            ...
                            <div className="col-md-8">
                              <div className="university">
                                ...
                                <div className="">
                                  ...
                                  <a
                                    href="mbbs-in-poland/medical-university-of-gdansk"
                  ...
                  <div className="row pt-5">
                    ...
                    <div className="col-md-6">
                      <div className="university">
                        ...
                        <p className="pt-2 pb-2 text-justify">
                          Texila University of Health and Science is one of the
                          ...
                          <div className="card m-1">
                            ...
                            >
                              <div className="card-body">
                                ...
                                and for practical classes but in china it is
...
export default MedicalUniversityOfWarsaw