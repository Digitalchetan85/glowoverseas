                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="../mbbs-in-poland.php">MBBS in Poland</a></li>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Medical University of Gdansk</h3>
                                </div>
                            </div>
                        ...
                        <div className="b-poland-image">
                            <div className="m-2">
                                <div className="row">
                                    <div className="col-md-12">
                                        <h2 className="text-center"><u>About Poland</u></h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <div className="">
                                            ...
                                            <p className="text-white">Warsaw - Capital of Poland</p>
                                            <p className="text-white">Language spoken - Polish and English</p>
                                            <p className="text-white">National currency is Polish Zolty. 1 USD = 3.73, Zolty</p>
                                        </div>
                                        <div className="poland-map">
                                            <p className="text-white text-center">Population – 64.6 Lakhs<br>
                                                Territory – 199.51 sq. km</p>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-4">
                                        <div className="pt-1 pb-1">
                                            ...
                                            <p className="text-white">Poland in religious geography lies on the boundaries separating Roman Catholic, Eastern Orthodox and Islamic spheres of influence.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Education system</h5>
                                            <p className="text-white">Unlike many other European countries higher education in Poland is comparatively cost effective.It is indeed, recommended for anyone seeking for quality and affordable education abroad.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Major cities</h5>
                                            <p className="text-white">Warsaw, Krakow, Gdańsk, Wrocław</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="top-medical-university pt-5 pb-5">
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Poland at Kharkiv National Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            Many students and parents are doubting whether Indian food is available or not. In Poland surely we get Indian food. Indian Restaurants are available. So students can easily concentrate on his studies rather than thinking about Food.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            In Poland Medical Universities provides a quality hostel facility with security cameras and also Internet Facilities are available. Separate Indian hostel facilities also available who are booking your seat at the earliest. Hostel to College will be a reachable distance between 1 to 2km.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="row pt-5">
                                <div className="col-md-12">
                                    <div className="university">
                                        <h5 className="text-center pb-5">Admission Process for MBBS in Poland</h5>
                                        <div className="text-center">
                            ...
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        <h4 className="text-center">Other Top Medical Universities in Poland</h4>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Medical University of Warsaw is one of the top Medical University in Poland. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-poland/medical-university-of-warsaw.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
