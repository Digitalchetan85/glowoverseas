                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Medical University of Gdansk</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                  ...
                  <div className="row pt-2">
                    <div className="col-md-6">
                      ...
                      <p className="text-justify pb-2">
                                            Gdansk Medical University was founded on October 8, 1945. The university has an old tradition for practicing medicine, teaching in medical and natural science monitored by eminent experts of respective subjects.
                                        </p>
                                        <p className="text-justify pb-2">
                                        ...
                                        <p className="text-justify pb-2">
                                            University has a Medical Simulation Canter, modern sports canter and student’s club association to organize the activities like student exchange programs, press, conferences, etc.
                                        </p>
                                        <ul>
                          ...
                          <div className="row">
                            <div className="col-md-8">
                              <div className="university">
                                ...
                                Medical-university of Warsaw one of
                                  the top Medical University in Ukraine. Get
                                  more details on Fees Structure, Hostel, Indian
                                  Food Facility and other uncleared information.
                                </p>
                                <div className="">
                                  {/* <?php include '../templates/university-book-now.php'  ?> */}
                                  <a
                                    href="mbbs-in-poland/medical-university-of-warsaw"
