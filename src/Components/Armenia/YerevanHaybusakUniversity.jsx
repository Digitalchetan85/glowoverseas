        ...
        <div className="container">
          ...
          <div className="study-armenia mb-2">
            <div className="row">
              <div className="col-md-12">
                <div className="pb-2">
                  <h4 className="text-center text-md-start pt-2 pb-2">MBBS in Armenia</h4>
                  {/* <img
            ...
            <div className="row pt-5">
              <div className="col-md-12">
                <div className="university">
                  ...
                  <div className="text-center">
                    <Image src={Process} alt="" className="img-fluid"></Image>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-md-12">
                <div className="university">
                  <ul>
                    ...
                    <li>
                      Step 10: Assisting students till completion of the course
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="row pt-5">
              ...
              <div className="col-md-6">
                <div className="university">
                  ...
                  <p className="pt-2 pb-2 text-justify">
                    Spartan University of Health and Science is one of the top
                    Medical University in USA. Get more details on Fees
                    Structure, Hostel, Indian Food Facility and other uncleared
                    information.
                  </p>
                  <div className="">
                    {/* <?php include '../templates/university-book-now.php'  ?> */}
              ...
              <div className="col-md-6">
                <div className="university">
                  ...
                  <p className="pt-2 pb-2 text-justify">
                    ...
                    University in Poland. Get more details on Fees Structure,
                    Hostel, Indian Food Facility and other uncleared
                    information.
                  </p>
                  <div className="">
                    {/* <?php include '../templates/university-book-now.php'  ?> */}
              ...
              <div className="col-md-6">
                <div className="university">
                  ...
                  <p className="pt-2 pb-2 text-justify">
                    Batumi Shota Rustaveli State Medical University one of the
                    top Medical University in Georgia. Get more details on Fees
                    Structure, Hostel, Indian Food Facility and other uncleared
                    information.
                  </p>
                  <div className="">
              ...
              <div className="col-md-6">
                <div className="university">
                  ...
                  <p className="pt-2 pb-2 text-justify">
                    Bashkir State Medical University one of the top Medical
                    University in Russia. Get more details on Fees Structure,
                    Hostel, Indian Food Facility and other uncleared
                    information.
                  </p>
                  <div className="">
              ...
              <div className="col-md-6">
                <div className="university">
                  ...
                  <p className="pt-2 pb-2 text-justify">
                    Kharkiv international Medical University one of the top
                    Medical University in Ukraine. Get more details on Fees
                    Structure, Hostel, Indian Food Facility and other uncleared
                    information.
                  </p>
                  <div className="">
              ...
              <div className="col-md-6">
                <div className="university">
                  ...
                  <Image src={Belarus} alt="" className="img-fluid" />
                  <p className="pt-2 pb-2 text-justify">
                    Belarusian State Medical University one of the top Medical
                    University in Belarus. Get more details on Fees Structure,
                    Hostel, Indian Food Facility and other uncleared
                    information.
                  </p>
                  <div className="">
                    ...
                    <div className="card m-1">
                      ...
                      >
                        <div className="card-body">
                          As per the Law, the students cannot take up a full
                          time/part-time job, while living on the “Student’s
                          well acquire his educational qualification, to fulfill
                          his main aim of arrival than taking up any part-time
                          assignments, which are generally low paid. A foreign
                          citizen can work only if their employer is licensed to
                          hire particular foreign citizen/citizens. The students
                          are liable to expulsion from the educational
                          establishments due to poor attendance poor academic
                          record due to such activities.
                        </div>
                      </div>
                    </div>
                    <div className="card m-1">
                      ...
                      >
                        <div className="card-body">
                          Yes, even it has now become as custom, that most of
                          the parents arrive during the degree award function
                          every year to share the precious moment with their
                          children. A special invitation is needed for a visa.
                          For which students can approach the Dean’s office for
                          assistance.
                        </div>
                      </div>
                    </div>
                    <div className="card m-1">
                      <div className="card-header" id="headingThree">
                        <h5 className="mb-0">
                          ...
                          >
                            How much expenses should students have for books &
                            other materials?
                          </button>
                        </h5>
                      </div>
                      ...
                      >
                        <div className="card-body">
                          Academic books are provided to the students from the
                          library of the institution, free of cost. Besides
                          students can get additional reading material from the
                          “Reading rooms” for no charges, students can also use
                          the internet and other means for getting the
                          literature or other books.
                        </div>
                      </div>
                    </div>
                    <div className="card m-1">
                      <div className="card-header" id="headingFour">
                        <h5 className="mb-0">
                          ...
                          >
                            If students are not well are facilities available
                            for the emergency?
                          </button>
                        </h5>
                      </div>
                      ...
                      >
                        <div className="card-body">
                          ...
                          compulsory routine before the start of every academic
                          year. A doctor is always available in the “Health care
                          point” of the hostel for the free consultation. In
                          case of any emergency, the doctor with an ambulance
                          can be called free of cost, any time.
                        </div>
                      </div>
                    </div>
                    <div className="card m-1">
                      <div className="card-header" id="headingFive">
                        <h5 className="mb-0">
                          ...
                          >
                            Is it necessary to learn the local language of the
                            country?
                          </button>
                        </h5>
                      </div>
                      ...
                      >
                        <div className="card-body">
                          local Language is the official language in any country
                          and forms a part of the curriculum for making it easy
                          for foreign students to converse with the local
                          population and the patients during their entire MBBS
                          course.Any country students opt for MBBS studies is
                          the important to learn the language for the day to day
                          life and for practical classNamees but in china it is
                          compulsory to read speak and write the language from
                          HSK 1 TO HSK 4 Level for any international students .
                        </div>
                      </div>
                    </div>
                    <div className="card m-1">
                      <div className="card-header" id="headingSix">
                        <h5 className="mb-0">
                          ...
                          >
                            what is the eligibility cretiria to take admission
                            in any foregn medical university ?
                          </button>
                        </h5>
                      </div>
                      <div
                      ...
                      >
                        <div className="card-body">
                          The student must have passed (12th Standard) with
                          physics, chemistry, biology & English from a
                          recognized board with a minimum mark of 50% in
                          physics, chemistry and biology in aggregate (General
                          category) and 40% for other reserved categories.
                        </div>
                      </div>
                    </div>
                    <div className="card m-1">
