...
const EastEuropianUniversityFacultyofHealthcareSciences = () => {
              ...
              <div className="container">
                ...
                <div className="study-georgia mb-2">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="pb-2">
                        <h4 className="text-center ">MBBS in Georgia</h4>
                        <p className="text-justify">
...
export default EastEuropianUniversityFacultyofHealthcareSciences;
