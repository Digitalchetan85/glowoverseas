...
const CaucasusInternationalMedicalUniversity = () => {
  return (
    <>
<div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="../mbbs-in-georgia.php">MBBS in Georgia</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Caucasus International Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Caucasus International Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Caucasus International University (CIU) is based in capital city of Georgia, Tbilisi; it has 20 years of history. Everything started in 1995, when several people’s idea became reality and a higher educational institution, under the name of Caucasus International University, was founded in Georgia. CIU easily became one of the leading universities in the country within the next ten years.</p>
                                        <p className="text-justify pb-2">From the very beginning, Caucasus International University set the goal to become university of western standards. For years, one of the priorities of the university has been the students’ employment programs. During studying process emphasis is placed on developing students’ professional skills and obtaining profound knowledge in their field. </p>
                                        <p className="text-justify pb-2">Caucasus International University offers Bachelor, One-step (in Georgian, English and Russian), Master and Doctoral programs and encompasses five faculties. Programs are distinguished by high-qualified academic staff and scientific-research centres which meet modern, international standards. CIU and all of its programs are accredited by the Government of Georgia. In addition, CIU faculty of medicine is approved by World Health organization (WHO) and listed in World Dictionary of medical Schools (WDOMS).</p>
                                        <p className="text-justify pb-2">Currently, Caucasus International University has sits for 4700 students and is considered to be one of the biggest universities of Georgia. CIU has the ambition to be the fastest developing and the most international University in the Region
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Georgia at Caucasus International Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            Many students and parents are doubting whether Indian food is available or not. In Georgia surely we get Indian food. Indian Restaurants are available. So students can easily concentrate on his studies rather than thinking about Food.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            In Georgian Medical Universities provides a quality hostel facility with security cameras and also Internet Facilities are available. Separate Indian hostel facilities also available who are booking your seat at the earliest. Hostel to College will be a reachable distance between 1 to 2km.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Batumi Shota Rustaveli State Medical University is one of the top Medical University in Georgia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            David Tvildiani Medical University is one of the top Medical University in Georgia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            New Vision University is one of the top Medical University in Georgia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-georgia/new-vision-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Tbilisi State Medical University is one of the top Medical University in Georgia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
...
export default CaucasusInternationalMedicalUniversity