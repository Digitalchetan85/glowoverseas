                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Caucasus International University (CIU) is based in
                          capital city of Georgia, Tbilisi; it has 20 years of
                          history. Everything started in 1995, when several
                          people’s idea became reality and a higher educational
                          institution, under the name of Caucasus International
                          University, was founded in Georgia. CIU easily became
                          one of the leading universities in the country within
                          the next ten years.
                        </p>
                        <p className="text-justify">
                          From the very beginning, Caucasus International
                          University set the goal to become university of
                          western standards. For years, one of the priorities of
                          the university has been the students’ employment
                          programs. During studying process emphasis is placed
                          on developing students’ professional skills and
                          obtaining profound knowledge in their field.{" "}
                        </p>
                        <p className="text-justify">
                          Caucasus International University offers Bachelor,
                          One-step (in Georgian, English and Russian), Master
                          and Doctoral programs and encompasses five faculties.
                          Programs are distinguished by high-qualified academic
                          staff and scientific-research centres which meet
                          modern, international standards. CIU and all of its
                          programs are accredited by the Government of Georgia.
                          In addition, CIU faculty of medicine is approved by
                          World Health organization (WHO) and listed in World
                          Dictionary of medical Schools (WDOMS).
                        </p>
                        <p className="text-justify">
                          Currently, Caucasus International University has sits
                          for 4700 students and is considered to be one of the
                          biggest universities of Georgia. CIU has the ambition
                          to be the fastest developing and the most
                          international University in the Region
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Georgia at Caucasus International
                          Medical University an affordable cost. Fell free to
