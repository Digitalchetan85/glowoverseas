                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Akaki Tsereteli State University Faculty of Medicine</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Akaki Tsereteli State University Faculty of Medicine</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                       ...
                                       Akaki Tsereteli State University Faculty of Medicine is one of the first choices of students among all medical institutes located in Tbilisi, Georgia. Established by David Tvildiani and Dr Dimitri Tvildiani in the year of 1989, the university is always a prime choice of worldwide medical aspirants for doing MBBS.</p>
                                        <p className="text-justify pb-2">David Tvildiani Medical University aims to provide higher medical education to worldwide students along with affordable fee structure, modern infrastructure, basic amenities, accommodation facilities and also developed PhD, doctorate programs, nursing school and AIETI Medical School.</p>
                                        <p className="text-justify pb-2">Currently, 200 graduates have passed from Akaki Tsereteli State University Faculty of Medicine and are working as physicians in USA and European Universities and Clinics.</p>
                                        <p className="text-justify pb-2">The students who have graduated fromAkaki Tsereteli State University Faculty of Medicine have successfully cleared the international exams like USMLE, PLAB, NMC. Some students are currently developing their skills at clinics and research centres of different countries, some students became proficient teachers and many students have earned their PhD degree from DTMU.
                        ...
                        <div className="top-medical-university pt-5 pb-5">
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Georgia at David Tvildiani Medical Universityan affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                            ...
                            <div className="row pt-5">
                                <div className="col-md-12">
                                    <div className="university">
                                        <h5 className="text-center pb-5">Admission Process for MBBS in Georgia</h5>
                                        <div className="text-center">
                            ...
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        <h4 className="text-center">Other Top Medical Universities in Georgia</h4>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Caucasus International Medical University is one of the top Medical University in Georgia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
...
export default AkakiTsereteliState