                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Akaki Tsereteli State University Faculty of Medicine
                          is one of the first choices of students among all
                          medical institutes located in Tbilisi, Georgia.
                          Established by David Tvildiani and Dr Dimitri
                          Tvildiani in the year of 1989, the university is
                          always a prime choice of worldwide medical aspirants
                          for doing MBBS.
                        </p>
                        <p className="text-justify">
                          David Tvildiani Medical University aims to provide
                        ...
                        <p className="text-justify">
                          Currently, 200 graduates have passed from Akaki
                          Tsereteli State University Faculty of Medicine and are
                          working as physicians in USA and European Universities
                          and Clinics.
                        </p>
                        <p className="text-justify">
                          The students who have graduated fromAkaki Tsereteli
                          State University Faculty of Medicine have successfully
                          cleared the international exams like USMLE, PLAB, NMC.
                          Some students are currently developing their skills at
