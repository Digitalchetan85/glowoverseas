                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Batumi Shota Rustaveli State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Batumi Shota Rustaveli State Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        The Batumi Shota Rustaveli State University is the higher educational university in Batumi, capital of the Autonomous Republic of Adjara. Georgia. It is named after the medieval Georgian poet Shota Rustaveli. Batumi Shota Rustaveli State University was founded in the year 1923. Khusein Nakaidze was the first director of the Institute. The Batumi Shota Rustaveli State University has started preparatory courses for students in the year of 1935.The academic faculty of university involves 273 professors, 71 researchers, 387 visiting professors. The institute offers 42 vocational, 43 bachelor’s, 23 masters, 8-doctoral and 2 single-level programs.Batumi Shota Rustaveli State University is the multifunctional edical school that provides professional and research-based education to UG & PG students.</p>
                                        <p className="text-justify pb-2">The university has an affiliation with leading medical universities abroad encourage the students to participate in scientific conferences and research programs.
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Georgia at Batumi Shota Rustaveli State Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Davis Tvildiani Medical University is one of the top Medical University in Georgia. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
...
export default BatumiShotaRustaveliStateMedicalUniversity