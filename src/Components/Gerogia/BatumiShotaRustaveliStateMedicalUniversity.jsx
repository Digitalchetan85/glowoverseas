...
const BatumiShotaRustaveliStateMedicalUniversity = () => {
  ...
  return (
    <>
      ...
      <div id="abt" className="py-md-3">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <div className="py-md-5">
                <h2 className="py-2">MBBS in Georgia</h2>
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          The Batumi Shota Rustaveli State University is the
                          higher educational university in Batumi, capital of
                          the Autonomous Republic of Adjara. Georgia. It is
                          named after the medieval Georgian poet Shota
                          Rustaveli. Batumi Shota Rustaveli State University was
                          founded in the year 1923. Khusein Nakaidze was the
                          first director of the Institute. The Batumi Shota
                          Rustaveli State University has started preparatory
                          courses for students in the year of 1935.The academic
                          faculty of university involves 273 professors, 71
                          researchers, 387 visiting professors. The institute
                          offers 42 vocational, 43 bachelor’s, 23 masters,
                          8-doctoral and 2 single-level programs.Batumi Shota
                          Rustaveli State University is the multifunctional
                          edical school that provides professional and
                          research-based education to UG & PG students.
                        </p>
                        <p className="text-justify">
                          The university has an affiliation with leading medical
                          universities abroad encourage the students to
                          participate in scientific conferences and research
                          programs.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Georgia at Batumi Shota Rustaveli State
