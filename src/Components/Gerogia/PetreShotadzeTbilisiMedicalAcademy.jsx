                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Petre Shotadze Tbilisi Medical Academy Faculty of
                          Medicine of the top Medical University in Georgia.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-2">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Georgia at Petre Shotadze Tbilisi
                          Medical Academy Faculty of Medicine affordable cost.
                          Fell free to talk to our counsellors to get the
