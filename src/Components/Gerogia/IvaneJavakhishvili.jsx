                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Ivane Javakhishvili Tbilisi State University Faculty of Medicine</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Ivane Javakhishvili Tbilisi State University Faculty of Medicine</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        New Vision University sparks through it’s excellence when it comes to international standard of education. New Vision University is a non-profit private institute started off in 2013 at Tbilisi, known as the capital of Georgia.</p>
                                        <p className="text-justify pb-2">MBBS program in New Vision University has official accreditations from National Medical Commission (NMC), and World Health Organization (WHO).</p>
                                        <p className="text-justify pb-2">MBBS duration in New Vision University is 6 years where last year is allocated for the course of internship. A medium used for instruction of the MBBS curriculum is in English language.</p>
                                        <p className="text-justify pb-2">A New Vision University ranks at 21th position in Georgia that draws the attention of foreign students. 
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Georgia at New Vision University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
...
export default IvaneJavakhishvili