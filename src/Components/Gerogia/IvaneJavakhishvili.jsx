                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          New Vision University sparks through it’s excellence
                          when it comes to international standard of education.
                          New Vision University is a non-profit private
                          institute started off in 2013 at Tbilisi, known as the
                          capital of Georgia.
                        </p>
                        <p className="text-justify">
                          MBBS program in New Vision University has official
                          accreditations from National Medical Commission (NMC),
                          and World Health Organization (WHO).
                        </p>
                        <p className="text-justify">
                          MBBS duration in New Vision University is 6 years
                          where last year is allocated for the course of
                          internship. A medium used for instruction of the MBBS
                          curriculum is in English language.
                        </p>
                        <p className="text-justify">
                          A New Vision University ranks at 21th position in
                          Georgia that draws the attention of foreign students.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Georgia at New Vision University an
