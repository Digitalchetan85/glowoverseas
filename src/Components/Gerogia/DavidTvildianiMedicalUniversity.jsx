                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">David Tvildiani Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">David Tvildiani Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        David Tvildiani Medical University is one of the first choices of students among all medical institutes located in Tbilisi, Georgia. Established by David Tvildiani and Dr Dimitri Tvildiani in the year of 1989, the university is always a prime choice of worldwide medical aspirants for doing MBBS.</p>
                                        ...
                                        <p className="text-justify pb-2">Currently, 200 graduates have passed from David Tvildiani Medical University and are working as physicians in USA and European Universities and Clinics.</p>
                                        <p className="text-justify pb-2">The students who have graduated from David Tvildiani Medical University have successfully cleared the international exams like USMLE, PLAB, NMC. Some students are currently developing their skills at clinics and research centres of different countries, some students became proficient teachers and many students have earned their PhD degree from DTMU.
