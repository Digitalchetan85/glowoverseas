...
import img2 from "../../Images/mbbs-in-georgia/medical-universities/david-tvildiani-medical-university-aieti-medical-school.png";
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          David Tvildiani Medical University is one of the first
