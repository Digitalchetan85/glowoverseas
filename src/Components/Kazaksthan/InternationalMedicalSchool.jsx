              ...
              <div className="pt-5 pb-5">
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <a href="/mbbs-in-kazakhstan">MBBS in Kazakhstan</a>
                    </li>
                    ...
                    <div className="col-md-6">
                      <div className="university">
                        <p className="text-justify pb-2">
                          ...
                          International Business- Almaty. The International
                          Medical School (IMS), embraces the principle that
                          mirrors the values of the medical profession. Many
                          students look for an MBBS college in foreign countries
                          with similar standards of education, MBBS in
                          Kazakhstan gives a lot of opportunity to the students
                          willing to pursue MBBS abroad. IMS is providing “Smart
                          Medicine” program, which is General Medicine - 5 years
                          MD Course in English Medium. This Course is equivalent
                          to M.B.B.S. program in India.
                        </p>
                        <ul>
                          <li>University Type - Private University </li>
                          <li>University Started - 2020</li>
                    ...
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Kazakhstan at International Medical
                          School an affordable cost. Fell free to talk to our
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              <div className="university">
                                ...
                                <p className="pt-2 pb-2 text-justify text-center">
                                  Al-Farabi National Medical University one of
                                ...
                                <div className="">
                                  ...
                                  <a
                                    href="mbbs-in-kazaksthan/international-medical-school"
                            ...
                            <div className="col-md-6">
                              <div className="university">
                                ...
                                <Image src={JSC} alt="" className="img-fluid" />
                                <p className="pt-2 pb-2 text-justify text-center">
                                  JSC National Medical University is one of the
                                ...
                                <div className="">
                                  {/* <?php include '../templates/university-book-now.php'  ?> */}
                                  <a
                                    href="mbbs-in-kazaksthan/jsc-national-medical-university"
                                    className="pt-2 pb-2 btn btn-warning m-2 float-right"
                                  >
                                    Read more
                                  </a>
...
export default InternationalMedicalSchool;
