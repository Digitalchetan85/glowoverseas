                ...
                <div className="pt-5 pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                          ...
                          <li className="breadcrumb-item"><a href="/mbbs-in-kazakhstan">MBBS in Kazakhstan</a></li>
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              <div className="university">
                                ...
                                <div className="">
                                  ...
                                  <a
                                    href="mbbs-in-kazaksthan/al-farabi-national-medical-university"
                            ...
                            <div className="col-md-6">
                              <div className="university">
                                ...
                                <Image src={International} alt="" className="img-fluid" />
                                <p className="pt-2 pb-2 text-justify text-center">
                                International Medical Schoolis one of the
