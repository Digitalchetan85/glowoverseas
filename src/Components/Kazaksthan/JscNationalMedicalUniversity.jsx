                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          JSC National Medical University – Almaty. Kazakh
                          national medical University is a milestone in the
                          history of education, medicine and the country as a
                          whole. These are traditions that have become the basis
                          of professionalism. It is a large medical fraternity,
                          the connection of times and names, time for energy of
                          scientists and teachers. The University, which built
                          its foundation on the basis of science, education and
                          practice, can rightly be proud of its achievements.
                          Quality organization of training, scientific and
                          clinical activities, high level of qualification of
                          doctors, recognition medical community has become a
                          visiting card of KazNMU.
                        </p>
                        <ul>
