                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Dnipropetrosk State Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Dnipropetrovsk State Medical Academy (DSMA) – is the centre of education, Science and Culture of exceptionally industrial area of Dnieper, Ukraine. The city of Dnipropetrovsk is the primary Industrial city of Ukraine.Above than 40% industry of Ukraine is situated in Dnipropetrovsk. It is known as the industrial & manufacturer city of Ukraine.</p>
                                        <p className="text-justify pb-2">The city is exceedingly created and settled in all parts of life. Dnipropetrovsk State Medical Academy (DSMA) is one of the most seasoned higher education foundation of Ukraine having fourth (the most astounding) level of accreditation in Ukraine.Dnipro State Medical University (DSMU) is having the highest (the 4th) level of accreditation among all universities of Ukraine. In 1922 the Dnipro State Medical University (DSMU) organized and edited two scientific medical journals: “Ekaterynoslavsky Medical Journal” and “New Surgical Archive”. When the Academy created a single scientific society that was theoretical, surgical, therapeutic, orthopedic, trauma and pediatric sections.Dnipropetrovsk State Medical University is the only in all over Ukraine, providing training to students in all seven faculties and preparatory department for foreign citizens.
