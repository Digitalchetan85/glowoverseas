                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Kyiv Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Kyiv Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        As a university with the highest level of accreditation by the Ministry of Education and Science of Ukraine, all degrees issued to foreign students are legalized and apostilized by the Foreign Affairs Ministry of Ukraine.</p>
                                        <p className="text-justify pb-2">Kyiv Medical University (KMU) is recognized and listed in all relevant international directories of medical universities such as the International Medical Education Directory (IMED).</p> 
                                        <p className="text-justify pb-2">Kyiv Medical University is one of the leading medical school in Ukraine. Kyiv Medical University was established in 1992 by V. Pokanevich (1950-2012). The university consists of honored doctor of Ukraine, associate professor, candidates of medical science, Ukrainian association of traditional medicine, etc. University establishes clinical and teaching base along with the introduction of latest technology.</p>
                                        <p className="text-justify pb-2">Around 350 highly skilled teachers train the students, out of them some of the well-known scholars, Ph.D., Masters etc. University provides practical exposure to students to achieve the required knowledge, skills to cater the demand of health-care industry.</p>
                                        <p className="text-justify pb-2">Industry exposure is provided to students through offshore internships. KMU has perfectly balanced curriculum meeting the requirement of Ministry of Health and Education of Ukraine.
...
export default KyivMedicalUniversity