...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/kyiv-medical-university-faculty-of-medicine.png";
...
const KyivMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Kyiv Medical University | MBBS in Ukraine | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/kyiv-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Kyiv Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
              ...
              <div className="col-md-12">
                <div className="container">
                  <div className="">
                    <div className="row">
                      <div className="col-md-12">
                        <h3 className="text-info">Kyiv Medical University</h3>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col-md-8">
                        <div className="university">
                          <p className="text-justify pb-2">
                            As a university with the highest level of
                            accreditation by the Ministry of Education and Science
                            of Ukraine, all degrees issued to foreign students are
                            legalized and apostilized by the Foreign Affairs
                            Ministry of Ukraine.
                          </p>
                          <p className="text-justify pb-2">
                            Kyiv Medical University (KMU) is recognized and listed
                            in all relevant international directories of medical
                            universities such as the International Medical
                            Education Directory (IMED).
                          </p>
                          <p className="text-justify pb-2">
                            Kyiv Medical University is one of the leading medical
                            school in Ukraine. Kyiv Medical University was
                            established in 1992 by V. Pokanevich (1950-2012). The
                            university consists of honored doctor of Ukraine,
                            associate professor, candidates of medical science,
                            Ukrainian association of traditional medicine, etc.
                            University establishes clinical and teaching base
                            along with the introduction of latest technology.
                          </p>
                          <p className="text-justify pb-2">
                            Around 350 highly skilled teachers train the students,
                            out of them some of the well-known scholars, Ph.D.,
                            Masters etc. University provides practical exposure to
                            students to achieve the required knowledge, skills to
                            cater the demand of health-care industry.
                          </p>
                          <p className="text-justify pb-2">
                            Industry exposure is provided to students through
                            offshore internships. KMU has perfectly balanced
                            curriculum meeting the requirement of Ministry of
                            Health and Education of Ukraine.
                          </p>
                          <ul>
