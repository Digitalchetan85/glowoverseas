...
const KharkivNationalMedicalUniversity = () => {
  return (
    <>
    <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Kharkiv National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Kharkiv National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Kharkiv National Medical University (KNMU) that was earlier known as Kharkiv Medical Institute and prior to that Kharkiv State Medical University.Kharkiv National Medical University is one of those pivotal universities who set the foundation of medical education in 1805. It started attracting international students after it received a status of national university.National Medical Commission (NMC), World Health Organization (WHO), and General Medical Council (GMC-Uk) have recognized the medical training program of Kharkiv National Medical University.</p>
                                        <p className="text-justify pb-2">The university appreciates the practical nature of education and that’s the reason 700 Indians learn medicine at the Kharkiv National Medical University. With the elegant force of 600 expert professors, the university has trained over 10,000 graduates who are now serving at superior positions of international hospitals.</p>
                                        <p className="text-justify pb-2">The education policy of KNMU includes quality assurance, university management, international contacts within the scope of the university’s competence. It is a renowned place to study medicine, surgery, radiology, dentistry, and anatomy at an economic rate of tuition fee structure.
                                ...
                                <div className="col-md-6">
                                    <div className="text-center">
                                        <img src="../images/mbbs-in-ukraine/medical-universities/kharkiv-national-medical-university.jpg" alt="" className="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="pb-2">
                                        ...
                                        <div className="text-center">
                                            <a as={Link} to="/" className="pt-2 pb-2 btn btn-warning m-2">Get Free Counselling</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default KharkivNationalMedicalUniversity