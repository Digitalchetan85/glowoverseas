...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/poltava-state-medical-university.png";
...
const PoltavaStateMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Poltava State Medical University | MBBS in Ukraine | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/poltava-state-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Poltava State Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Poltava State Medical and Dental University, also
                          known as the Ukrainian Medical and Stomatological
                          Academy, is a Ukrainian state-run medical and dental
                          school,In 1967, the university is moved to the city of
                          Poltava and named as Poltava State National Medical
                          University.In 1994, the Poltava Medical Dental
                          University received the accreditation of Ukrainian
                          Medical Dental Academy. About 4000 students are
                          studying in this academy. Out of them, 1200 are the
                          foreigners from 42 countries.Training is conducted for
                          medical and dental education.
                        </p>
                        <p className="text-justify pb-2">
                          The Poltava State Medical and Dental University is one
                          of the highly ranked University in Ukraine providing
                          quality Medical and Dental Education for undergraduate
                          students. From the year 1999 to 2009, academy
                          published over 710 educational benefits receiving 106
                          patents of Ukraine and Russia.
                        </p>
                        <p className="text-justify pb-2">
                          Ukrainian Medical and Dental Academy (UMDA) has
                          started teaching its students in accordance with the
                          Bologna Agreement using credit modular system.
                        </p>
                        <ul>
