...
const PoltavaStateMedicalUniversity = () => {
  return (
    <> <div id="abt">
                ...
                <div className="pt-5 pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                          ...
                          <li className="breadcrumb-item active" aria-current="page">Poltava State Medical University</li>
                        </ol>
                      </nav>
                </div>
            </div>
            ...
            <div className="col-md-8">
                <div className="container">
                    <div className="border p-2 m-1">
                        <div className="row">
                            <div className="col-md-12">
                                <h3 className="text-center">Poltava State Medical University</h3>
                            </div>
                        </div>
                        <div className="row pt-2">
                            <div className="col-md-6">
                                <div className="university">
                                    ...
                                    Poltava State Medical and Dental University, also known as the Ukrainian Medical and Stomatological Academy, is a Ukrainian state-run medical and dental school,In 1967, the university is moved to the city of Poltava and named as Poltava State National Medical University.In 1994, the Poltava Medical Dental University received the accreditation of Ukrainian Medical Dental Academy. About 4000 students are studying in this academy. Out of them, 1200 are the foreigners from 42 countries.Training is conducted for medical and dental education.</p>
                                    <p className="text-justify pb-2">The Poltava State Medical and Dental University is one of the highly ranked University in Ukraine providing quality Medical and Dental Education for undergraduate students. From the year 1999 to 2009, academy published over 710 educational benefits receiving 106 patents of Ukraine and Russia.</p>
                                    <p className="text-justify pb-2">Ukrainian Medical and Dental Academy (UMDA) has started teaching its students in accordance with the Bologna Agreement using credit modular system.
...
export default PoltavaStateMedicalUniversity