                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Black Sea National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Black Sea National Medical University</h3>
                                </div>
                            </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        <p className="text-justify pb-2">
                                            Petro Mohyla Black Sea National University is one of the top medical colleges in Ukraine. The university was established in the year 1996 as an extension of Kyiv-Mohyla Academy.In the year 2000, the university received its ‘state’ status, and subsequently, it received the ‘National’ university status in the year 2016. This university is one of the low budget destinations for students to study MBBS in Ukraine. recognized by WHO / NMC & ECFMG and in the year 2009, the university became a part of the European Association of universities.The University was ranked 44th among the best 200 educational institutions of Ukraine in the annual ranking of the UNESCO "Top 200 Ukraine" universities in 2015-2016.
                                        </p>
                                        <ul>
                                            <li>University Type - State University</li>
...
export default BlackSeaNationalMedicalUniversity