...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/danylo-halytsky-lviv-national-medical-university.png";
...
const LvivNationalMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Lviv National Medical University | MBBS in Ukraine | GOE</title>
        <link
          rel="canonical"
        ...
        <meta
          name="description"
          content="MBBS in Lviv National Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Danylo Halytsky Lviv National Medical University is
                          one of the leading medical universities in Ukraine
                          having the 4th level of accreditation affiliated with
                          the Ministry of Health of Ukraine. Lviv National
                          Medical University is named after Danylo Halytsky.
                          Danylo Halytsky Lviv National Medical University, —
                          formerly known as the Lviv State Medical Institute,
                          earlier the Faculty of Medicine of the John Casimir
                          University and, before that, Faculty of Medicine of
                          the Francis I University — is one of the oldest and
                          biggest medical universities in Ukraine
                        </p>
                        <p className="text-justify pb-2">
                          On November 16th 1784, University of Lviv was restored
                          with 4 faculties. In 2018, Danylo Halytsky was awarded
                          as Grand Prix “Leader of International Activities” and
                          also got a Gold Medal in the constitution of
                          “Implementations of Innovations in the pedagogical
                          process for improving the quality of graduates
                          knowledge”.
                        </p>
                        <p className="text-justify pb-2">
                          During the autumn of 1939, Lviv Medical University was
                          renamed Lviv Medical Institute. The Faculty of
                          Medicine formed a separate structure from the
                          University of Lviv. After which it became an
                          autonomous university as State Medical Institute, with
                          495 physicians in its first two years. In 1996, the
                          institute was upgraded into a university and was
                          renamed the Lviv State Medical University.
                        </p>
                        <p className="text-justify pb-2">
                          The council of a young scientist of university brings
                          together scientific and pedagogical workers of a
                          certain age category. This includes graduate interns,
                          graduates, postgraduates, clinical interns, candidates
                          in medical sciences, assistant professor, associate
                          professors.
                        </p>
                        <ul>
