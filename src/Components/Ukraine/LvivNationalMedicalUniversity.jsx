...
const LvivNationalMedicalUniversity = () => {
  return (
    <div>
        <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Lviv National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Lviv National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Danylo Halytsky Lviv National Medical University is one of the leading medical universities in Ukraine having the 4th level of accreditation affiliated with the Ministry of Health of Ukraine. Lviv National Medical University is named after Danylo Halytsky.
                                        Danylo Halytsky Lviv National Medical University, — formerly known as the Lviv State Medical Institute, earlier the Faculty of Medicine of the John Casimir University and, before that, Faculty of Medicine of the Francis I University — is one of the oldest and biggest medical universities in Ukraine</p>
                                        <p className="text-justify pb-2">On November 16th 1784, University of Lviv was restored with 4 faculties. In 2018, Danylo Halytsky was awarded as Grand Prix “Leader of International Activities” and also got a Gold Medal in the constitution of “Implementations of Innovations in the pedagogical process for improving the quality of graduates knowledge”.</p>
                                        <p className="text-justify pb-2">During the autumn of 1939, Lviv Medical University was renamed Lviv Medical Institute. The Faculty of Medicine formed a separate structure from the University of Lviv. After which it became an autonomous university as State Medical Institute, with 495 physicians in its first two years. In 1996, the institute was upgraded into a university and was renamed the Lviv State Medical University.</p>
                                        <p className="text-justify pb-2">The council of a young scientist of university brings together scientific and pedagogical workers of a certain age category. This includes graduate interns, graduates, postgraduates, clinical interns, candidates in medical sciences, assistant professor, associate professors.

                                        </p>
                                        <ul>
                                            <li>University Type - Government University</li>
                                            <li>Established in 1896.</li>
                        ...
                        <div className="study-ukraine p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="pb-2">
                        ...
                        <div className="b-ukraine-image p-2 m-1">
                            <div className="m-2">
                                <div className="row">
                                    <div className="col-md-12">
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <div className="">
                                            ...
                                            <p className="text-white">Kiev - Capital of Ukraine</p>
                        ...
                        <div className="top-medical-university pt-5 pb-5">
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Ukraine at Black Sea National Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling' ?>
                                        </div>
                            ...
                            <div className="row pt-5">
                                <div className="col-md-12">
                                    <div className="university">
                                        <h5 className="text-center pb-5">Admission Process for MBBS in Ukraine</h5>
                                        <div className="text-center">
                                    ...
                                    <div className="university">
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <div className="">
                                                            <?php include '../templates/university-free-councelling' ?>
                                                            <a as={Link} to="/mbbs-in-ukraine/dnipropetrovsk-national-medical-university" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Zaporizhzhia State Medical University</h5>
                                                        <img src="../images/mbbs-in-ukraine/medical-universities/zaporozhye-state-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
...
export default LvivNationalMedicalUniversity