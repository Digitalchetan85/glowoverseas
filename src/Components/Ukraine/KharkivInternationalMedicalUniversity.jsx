  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          {" "}
          Kharkiv International Medical University | MBBS in Ukraine | GOE
        </title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/kharkiv-international-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Kharkiv International Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Khakiv International Medical University one of the top
