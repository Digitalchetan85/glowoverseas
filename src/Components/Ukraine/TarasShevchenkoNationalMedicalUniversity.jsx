...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/taras-shevchenko-national-university-of-kyiv-institute-of-biology-and-medicine.png";
...
const TarasShevchenkoNationalMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title> Taras Schevchenko National | MBBS in Ukraine | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/taras-shevchenko-national-medical-university"
          x1
        />
        <meta
          name="description"
          content="MBBS Taras Schevchenko National Medical Universityis the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          The university is universally recognized as the most
                          prestigious university of Ukraine, being the largest
                          national higher education institution. Ukraine and has
                          a rich history of culture and education. There are
                          over 26,000 students already studying including Indian
                          students.
                        </p>
                        <p className="text-justify pb-2">
                          The Taras Shevchenko National University of Kyiv has
                          its motto as ‘Honour is Glory’ and is known for its
                          progressive thinking and advanced learning. There is
                          no language problem for foreign students as teaching
                          takes place in the English language. It is ranked #601
                          - 650 in QS Global World Rankings 2021.
                        </p>
                        <p className="text-justify pb-2">
                          Taras Shevchenko National University of Kyiv is
                          approved by NMC and WHO. Students can get relief from
                          their study pressure by health spa and sports club
                          provided by the university at the bank of river
                          Dnieper.
                        </p>
                        <ul>
