...
const TarasShevchenkoNationalMedicalUniversity = () => {
  return (
    <>
     <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a as={Link} to="/">MBBS in Ukraine</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Taras Schevchenko National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Taras Schevchenko National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        The university is universally recognized as the most prestigious university of Ukraine, being the largest national higher education institution. Ukraine and has a rich history of culture and education. There are over 26,000 students already studying including Indian students.</p>
                                        <p className="text-justify pb-2">The Taras Shevchenko National University of Kyiv has its motto as ‘Honour is Glory’ and is known for its progressive thinking and advanced learning. There is no language problem for foreign students as teaching takes place in the English language. It is ranked #601 - 650 in QS Global World Rankings 2021.</p>
                                        <p className="text-justify pb-2">Taras Shevchenko National University of Kyiv is approved by NMC and WHO. Students can get relief from their study pressure by health spa and sports club provided by the university at the bank of river Dnieper.
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <img src="../images/mbbs-in-ukraine/medical-universities/black-sea-national-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
...
export default TarasShevchenkoNationalMedicalUniversity