...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/ternopil-state-medical-university.png";
...
const TernopilStateMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Ternopil State Medical University | MBBS in Ukraine | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/mbbs-in-ukraine/ternopil-state-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Ternopil State Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p class="text-justify pb-2">
                          Ternopil State Medical University one of the top
