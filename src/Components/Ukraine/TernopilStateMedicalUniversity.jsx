...
const TernopilStateMedicalUniversity = () => {
  return (
    <div>
        <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Ternopil State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Ternopil State Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Ternopil State Medical University one of the top Medical University in Ukraine.
                                        </p>
                                        <ul>
...
export default TernopilStateMedicalUniversity