...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/v-n-karazin-kharkiv-national-university-school-of-medicine.png";
...
const VNKarazinKharkivNationalMedicalUniversity = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>V N Karazin National | MBBS in Ukraine | GOE</title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/v-n-karazin-kharkiv-national-medical-university"
        />
        <meta
          name="description"
              ...
              <div className="pt-5 pb-5">
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="/mbbs-in-ukraine">MBBS in Ukraine</Link>
                    </li>
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Karazin Kharkiv National University was founded in
                          November 1804 as the Kharkiv University. It is one of
                          the oldest higher educational institutions in eastern
                          Europe and the second oldest in Ukraine after the
                          University of Lviv. V.N. Karazin Kharkiv National
                          Medical University was established in November 1804 in
                          accordance with the charter of Tsar Alexander I. The
                          university has an important contribution towards the
                          Ukrainian national renaissance of the 19th to 20th
                          centuries. The V.N. Karazin Kharkiv National
                          University is well-known as the scientific and
                          academic hub of Ukraine.
                        </p>
                        <p className="text-justify pb-2">
                          V.N. Karazin Kharkiv National University is the only
                          university in Ukraine that has trained a number of
                          world-famous researchers, scholars, educators,
                          biologists, economist and Nobel prize laureates.
                        </p>
                        <p className="text-justify pb-2">
                          Since the university’s foundation, the university has
                          graduated around 130,000 students. Among them, 60
                          university graduates have become the academicians and
                          the member of the Ukrainian National Academy of
                          Sciences (UNAS). The university has developed a higher
                          education system in the Kharkiv region.
                        </p>
                        <p className="text-justify pb-2">
                          With the involvement of extensive international
                          cooperation, the V.N.Karazin Kharkiv National
                          University is an active member of the international
                          community of the leading European and World
                          universities.
                        </p>
                        <p className="text-justify pb-2">
                          In October 1999, the university has gained the status
                          of a National University and was named in honor of its
                          founder, V.N. Karazin.
                        </p>
                        <ul>
