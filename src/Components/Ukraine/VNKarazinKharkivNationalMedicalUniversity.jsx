...
const VNKarazinKharkivNationalMedicalUniversity = () => {
  return (
    <>
<div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">V N Karazin National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">V. N. Karazin National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Karazin Kharkiv National University was founded in November 1804 as the Kharkiv University. It is one of the oldest higher educational institutions in eastern Europe and the second oldest in Ukraine after the University of Lviv. V.N. Karazin Kharkiv National Medical University was established in November 1804 in accordance with the charter of Tsar Alexander I. The university has an important contribution towards the Ukrainian national renaissance of the 19th to 20th centuries. The V.N. Karazin Kharkiv National University is well-known as the scientific and academic hub of Ukraine.</p>
                                        V.N. Karazin Kharkiv National University is the only university in Ukraine that has trained a number of world-famous researchers, scholars, educators, biologists, economist and Nobel prize laureates.</p>
                                        <p className="text-justify pb-2">Since the university’s foundation, the university has graduated around 130,000 students. Among them, 60 university graduates have become the academicians and the member of the Ukrainian National Academy of Sciences (UNAS). The university has developed a higher education system in the Kharkiv region.</p>
                                        <p className="text-justify pb-2">With the involvement of extensive international cooperation, the V.N.Karazin Kharkiv National University is an active member of the international community of the leading European and World universities.</p>
                                        <p className="text-justify pb-2">In October 1999, the university has gained the status of a National University and was named in honor of its founder, V.N. Karazin.
...
export default VNKarazinKharkivNationalMedicalUniversity