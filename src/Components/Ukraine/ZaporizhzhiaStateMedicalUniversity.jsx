...
const ZaporizhzhiaStateMedicalUniversity = () => {
  return (
    <>
<div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Zaporizhzhia State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Zaporizhzhia State Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Zaporizhzhia State Medical University is a medical university in the small city of Zaporizhzhia, Ukraine. Zaporizhzhia State Medical University is a modern, multi-profile higher education institution of the 4th level of accreditation with the right of autonomous management, In 1994, the institute received the status of State Medical University which provides higher education services offering courses in bachelor, master, specialists, postgraduate studies, internships, doctoral studies, pharmacists, etc.</p>
                                        <p className="text-justify pb-2">It is one of the oldest & best medical higher educational institutions in Ukraine. For more than 40 years, it has gained authority and recognition by training foreign citizens from Europe, Latin America, USA, Canada, Asia, and Africa. More than 3500 specialists have got medical and pharmaceutical education and are working now in more than 100 countries of the world, taking up high positions in the public health systems of their countries.

                                        </p>
                                        <ul>
                                            <li>University Type - Government University</li>
                                            <li>Established in 1903.</li>
...
export default ZaporizhzhiaStateMedicalUniversity