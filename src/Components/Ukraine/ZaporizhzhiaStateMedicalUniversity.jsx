...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/zaporozhye-state-medical-university.png";
  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          {" "}
          Zaporizhzhia State Medical University | MBBS in Ukraine | GOE
        </title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/zaporizhzhia-state-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Zaporizhzhia State Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Zaporizhzhia State Medical University is a medical
                          university in the small city of Zaporizhzhia, Ukraine.
                          Zaporizhzhia State Medical University is a modern,
                          multi-profile higher education institution of the 4th
                          level of accreditation with the right of autonomous
                          management, In 1994, the institute received the status
                          of State Medical University which provides higher
                          education services offering courses in bachelor,
                          master, specialists, postgraduate studies,
                          internships, doctoral studies, pharmacists, etc.
                        </p>
                        <p className="text-justify pb-2">
                          It is one of the oldest & best medical higher
                          educational institutions in Ukraine. For more than 40
                          years, it has gained authority and recognition by
                          training foreign citizens from Europe, Latin America,
                          USA, Canada, Asia, and Africa. More than 3500
                          specialists have got medical and pharmaceutical
                          education and are working now in more than 100
                          countries of the world, taking up high positions in
                          the public health systems of their countries.
                        </p>
                        <ul>
