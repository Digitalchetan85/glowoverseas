...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/vinnitsa-national-pirogov-memorial-medical-university.png";
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Vinnitsa National Medical University | MBBS in Ukraine | GOE
        </title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/vinnitsa-national-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Vinnitsa National Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Vinnitsa National Medical University one of the top
