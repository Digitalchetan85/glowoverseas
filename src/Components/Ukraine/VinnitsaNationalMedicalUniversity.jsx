...
const VinnitsaNationalMedicalUniversity = () => {
  return (
    <div>
        <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Vinnitsa National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Vinnitsa National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-25">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Vinnitsa National Medical University one of the top Medical University in Ukraine.
                                        </p>
                                        <ul>
                            ...
                            <div className="row pt-5">
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <div className="text-center">
                                            <a as={Link} to="/" className="pt-2 pb-2 btn btn-warning m-2">Call Us for more details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <img src="../images/mbbs-in-ukraine/medical-universities/black-sea-national-medical-university.png" alt="" className="img"pirogov-memorial-medical-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
...
export default VinnitsaNationalMedicalUniversity