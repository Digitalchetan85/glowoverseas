...
const BukovinianStateMedicalUniversity = () => {
  return (
    <>
     <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Bukovinian State Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Bukovinian State Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Bukovinian State Medical University is the higher educational establishment in Chernivtsi, Ukraine. It was founded in the year 1944. The university has trained 25000 specialists in various disciplines like General Medicine, Pediatrics, Medical Psychology, Stomatology, Pharmacy.It is one of the multicultural educational institutions accredited by WHO, Magna Charta Universitatum, Association of Carpathian region with qualified training as per grade system of education.The foundation is associated with names of well-known scientists.</p>
                                        <p className="text-justify pb-2">The university graduates enhance their skills in Medical, Educational, Pharmaceutical, Social and Cultural Spheres. The university organizes the online lectures by a well-known scientist for students from Ukraine and abroad also.
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Ukraine at Bukovinian State Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling' ?>
                                        </div>
...
export default BukovinianStateMedicalUniversity