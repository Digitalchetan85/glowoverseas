...
import img1 from "../../Images/mbbs-in-ukraine/medical-universities/bukovinian-state-medical-university.png";
  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          {" "}
          Bukovinian State Medical University | MBBS in Ukraine | GOE
        </title>
        <link
          rel="canonical"
          href="https://glowoverseas.com/mbbs-in-ukraine/bukovinian-state-medical-university"
        />
        <meta
          name="description"
          content="MBBS in Bukovinian State Medical University is the best place to Study MBBS in Ukraine. Call Us for Free Counselling"
        />
      </Helmet>
      <div id="abt">
