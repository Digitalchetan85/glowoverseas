...
const IvanoFrankviskNationalMedicalUniversity = () => {
  return (
    <>
 <div id="abt">
                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Ivano-Frankvisk National Medical University</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Ivano-Frankvisk National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        In 1945, the Ivano Frankivsk National Medical University was founded. The university is located in Ivano Frankivsk city and it is the non-profit public medical institution.The Ivano Frankivsk National Medical University is recognized by the World Health Organization (WHO), National Medical Commission (NMC), and the world directory of medical schools. It is the leading and one of the oldest medical universities in Ukraine.It has a total of 12 hospitals and clinics and there are a total of 48 departments at the Ivano Frankivsk National Medical University.</p>
                                        <p className="text-justify pb-2">Ivano is one of the beautiful cities of Ukraine, an important scientific and cultural center. State establishment Ivano Frankivsk National Medical University [IFNMU] is a modern institution of higher education with rich traditions.Establishment of Ivano Frankivsk National Medical University was founded in the year of 1945. Ivano Frankivsk National Medical University is one of the oldest and leading medical University of Ukraine from last 68 years and former USSR. High level of qualification allows graduates of the University to work successfully in many countries of the world, to achieve great success in science and practical public health services. Among them are scientists, heads of public health service, honoured doctors.
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Black Sea National Medical University one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-free-councelling' ?>
...
export default IvanoFrankviskNationalMedicalUniversity