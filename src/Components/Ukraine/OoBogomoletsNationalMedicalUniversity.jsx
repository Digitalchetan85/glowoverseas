...
const OoBogomoletsNationalMedicalUniversity = () => {
  return (
    <div>
        <div id="abt">
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">O O Bogomolets National Medical University</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="text-justify pb-2">The course of study in Medical Faculty is 5 years and in some other faculty is 4 year. The university itself is the broadband destination for students from all over the world.</p>
                                        <p className="text-justify pb-2">The Bogomolets university is one of the best medical university among the top ranked universities in the world.The Institutes not only provides a center of excellence in Medical field also it is the best for the center of learning. The University also provides the art of research facilities and equipment to students.
