                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="/mbbs-in-kyrgyzstan">MBBS in Kyrgyzstan</a></li>
                    ...
                    <div className="col-md-12">
                      <div className="university">
                        <h4 className="text-center">
                          Other Top Medical Universities in Kyrgyzstan
                        </h4>
                          ...
                          <div className="row">
                            <div className="col-md-8">
                              <div className="university">
                                ...
                                Salymbekov University is one of the top Medical University in Belarus. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information
                                </p>
                                <div className="">
                                  {/* <?php include '../templates/university-book-now.php'  ?> */}
                                  <a
                                    href="mbbs-in-kyrgystan/osh-state-medical-university
                                    "
