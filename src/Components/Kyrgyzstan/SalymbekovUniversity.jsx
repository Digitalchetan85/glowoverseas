                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="../mbbs-in-kyrgyzstan.php">MBBS in Kyrgyzstan</a></li>
                              <li className="breadcrumb-item active" aria-current="page">Salymbekov University Faculty of Medicine</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Salymbekov University Faculty of Medicine</h3>
                                </div>
                            </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        <p className="text-justify pb-2">
                                            Osh State University Medical Faculty – OSH. The Medical Faculties, Osh State University are a public medical institute located in Osh, Kyrgyzstan. It was opened in 1993 as of the reorganisation of the Osh State Pedagogical Institute into Osh State University.
                                        </p>
                                        <ul>
                        ...
                        <div className="study-kyrgyzstan mb-2">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="pb-2">
                                        <h4 className="text-center pt-2 pb-2">MBBS in Kyrgyzstan</h4>
                                        <img src="../images/mbbs-in-kyrgyzstan-flag.jpg.png" alt="" className="img-fluid rounded-circle ml-3">
                                        <p className="p-2 text-justify">
                                            MBBS in Kyrgyzstan is the study of five years which is to become a well-reputed doctor. The medical course is not easy for every candidate as they have to go through several entrance exams and counselling sessions. If they pass through all these then they can take an admission to complete the studies. If you are taking so much pain to complete your medical studies then why not get the degree from the top medical Universities in Kyrgyzstan. You might be surprised by the country name but if you take a closer look then you will find the truth about the same.
                                        </p>
                                        <p className="p-2 text-justify">
                                            MBBS in Kyrgyzstan, we should know about the excellent nation. It is situated in the core of central Asia, on the great silk street and has been tourist destination for understanding the historical backdrop of the general population living here and takes after a republic framework. Kyrgyz is the national language which has a ton of likeness like Russian. The nation is separated into seven regions, which comprise of various areas. Bishkek is the capital of the nation. Now-a-days, Kyrgyzstan is counted among the top countries offering MBBS admission in Kyrgyzstan to international students at a very affordable price. 
                                        </p>
                                        <p className="p-2 text-justify">
                                            Thousands of students from India have applied in the medical universities of Kyrgyzstan to pursue their medical degree in abroad. The quality of medical education provided in the universities of Kyrgyzstan is comparable to the European standards.
                                            <ul>
                                                <li>The degree awarded after completing the MBBS course is “DOCTOR OF MEDICINE”.</li>
                                                <li>The duration of MBBS course in Kyrgyzstan is 5 years </li>
                                                <li>Approved by all the medical boards </li>
                                                <li>Total number of medical universities in Kyrgyzstan - 22 Universities </li>
                                            </ul>
                                        </p>
                                        <div className="text-center">
                        ...
                        <div className="b-kyrgyzstan-image">
                            <div className="m-2">
                                <div className="row">
                                    <div className="col-md-12">
                                        <h2 className="text-center"><u>About kyrgyzstan</u></h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <div className="">
                                            ...
                                            <p className="text-white">Bishkek - Capital of Kyrgyzstan</p>
                                            <p className="text-white">Language spoken - Kyrgyz, Russian and English</p>
                                            <p className="text-white">National currency is Kyrgyzstani Soma. 1 USD = 84.77, Soma</p>
                                        </div>
                                        <div className="kyrgyzstan-map">
                                            <p className="text-white text-center">Population – 64,6 Lakhs<br>
                                                Territory – 19,951 sq. km</p>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-4">
                                        <div className="pt-1 pb-1">
                                            ...
                                            <p className="text-white">kyrgyzstan in religious geography lies on the boundaries separating Roman Catholic, Eastern Orthodox and Islamic spheres of influence.</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Education system</h5>
                                            <p className="text-white">Education System is same as Indian Education System. Asian curriculum and organized in a comprehensive system. Which stimulates all citizen have the right to Education?</p>
                                        </div>
                                        <div className="pt-1 pb-1">
                                            <h5 className="text-white">Major cities</h5>
                                            <p className="text-white">Bishkek, Osh, Jalal-Abad, Karakol</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="top-medical-university pt-5 pb-5">
                                ...
                                <div className="col-md-12">
                                    <div className="university">
                                        ...
                                        <p className="text-justify">
                                            Study MBBS in Kyrgyzstan at Osh State Medical University an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                                        </p>
                                        <div className="text-center">
                                            <<?php include '../templates/university-free-councelling.php' ?>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            Many students and parents are doubting whether Indian food is available or not. In Kyrgyzstan surely we get Indian food. Indian Restaurants are available. So students can easily concentrate on his studies rather than thinking about Food.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            In Osh State Medical University provides a quality hostel facility with security cameras and also Internet Facilities are available. Separate Indian hostel facilities also available who are booking your seat at the earliest. Hostel to College will be a reachable distance between 1 to 2km.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="row pt-5">
                                <div className="col-md-12">
                                    <div className="university">
                                        <h5 className="text-center pb-5">Admission Process for MBBS in Kyrgyzstan</h5>
                                        <div className="text-center">
                            ...
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        <h4 className="text-center">Other Top Medical Universities in Kyrgyzstan</h4>
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Asian State Medical University</h5>
                                                        <img src="../images/mbbs-in-kyrgyzstan/medical-universities/asian-medical-institute.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Asian State Medical University is one of the top Medical University in Kyrgyzstan. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-kyrgyzstan/asian-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">International State Medical University</h5>
                                                        <img src="../images/mbbs-in-kyrgyzstan/medical-universities/International-School-of-Medicine.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            International State Medical University is one of the top Medical University in Ukraine. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-kyrgyzstan/international-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Jalalabad State Medical University</h5>
                                                        <img src="../images/mbbs-in-kyryzstan/medical-universities/jalal-abad-state-university.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Jalalabad State Medical University is one of the top Medical University in Kyrgyzstan. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-kyrgyzstan/jalalabad-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="m-1 pt-2 pb-2 medical-university">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        <h5 className="pt-2 pb-2 text-center">Kyrgyz State Medical University</h5>
                                                        <img src="../images/mbbs-in-kyrgyzstan/medical-universities/kyrgyz-state-medical-academy.png" alt="" className="img-fluid">
                                                        <p className="pt-2 pb-2 text-justify">
                                                            Kyrgyz State Medical University is one of the top Medical University in Kyrgyzstan. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                                        </p>
                                                        <div className="">
                                                            <?php include '../templates/university-book-now.php'  ?>
                                                            <a href="../mbbs-in-kyrgyzstan/kyrgyz-state-medical-university.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
