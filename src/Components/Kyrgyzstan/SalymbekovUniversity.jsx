                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify">
                          Salymbekov University Faculty of Medicine. The Medical
                          Faculties, Osh State University are a public medical
                          institute located in Osh, Kyrgyzstan. It was opened in
                          1993 as of the reorganisation of the Osh State
                          Pedagogical Institute into Osh State University.
                        </p>
                        <ul>
