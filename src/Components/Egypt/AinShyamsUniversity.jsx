                    ...
                    <div className="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Ain Shams University Faculty of Medicine</li>
                            </ol>
                          </nav>
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className="container">
                        <div className="border p-2 m-1">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-center">Ain Shams University Faculty of Medicine</h3>
                                </div>
                            </div>
                            <div className="row pt-2">
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        Ain Shams University Faculty of Medicine one of the top Medical University in Egypt.
                                        </p>
                                        <ul>
                                            <li>Established in 1948.</li>
                        ...
                        <div className="top-medical-university pt-5 pb-5">
                                ...
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            Many students and parents are doubting whether Indian food is available or not. In Egypt surely we get Indian food. Indian Restaurants are available. So students can easily concentrate on his studies rather than thinking about Food.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="university">
                                        ...
                                        <p className="pt-2 pb-2 text-justify">
                                            In Egyptian Medical Universities provides a quality hostel facility with security cameras and also Internet Facilities are available. Separate Indian hostel facilities also available who are booking your seat at the earliest. Hostel to College will be a reachable distance between 1 to 2km.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row pt-5">
                                <div className="col-md-6">
                                    <div className="university">
                                        <h4 className="text-center">Other Top Medical Universities in Egypt</h4>
                                                ...
                                                <div className="col-md-12">
                                                    <div className="university">
                                                        ...
                                                        <div className="">
                                                            ...
                                                            <a href="../mbbs-in-egypt/cairo-university-faculty-of-medicine.php" className="pt-2 pb-2 btn btn-warning m-2 float-right">Read more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
