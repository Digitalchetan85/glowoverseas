...
import Cario from "../../Images/mbbs-in-egypt/medical-universities/cairo-university-faculty-of-medicine.png";
              ...
              <div className="pt-5 pb-5">
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <a href="/mbbs-in-egypt">MBBS in Egypt</a>
                    </li>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="pb-2">
                        ...
                        {/* <img
                          src="../Images/mbbs-in-egypt-flag.jpg.png"
                          alt=""
                        ...
                        <p className="p-2 text-justify"></p>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        Study MBBS in Egypt at Ain Shams University Faculty of Medicine an affordable cost. Fell free to talk to our counsellors to get the complete fee structure.
                        </p>
                        <div className="text-center">
                          ...
                          <div className="row">
                            <div className="col-md-8">
                              <div className="university">
                                ...
                                Cairo University Faculty of Medicine is one of the top Medical University in Egypt. Get more details on Fees Structure, Hostel, Indian Food Facility and other uncleared information.
                                </p>
                                <div className="">
                                  {/* <?php include '../templates/university-book-now.php'  ?> */}
                                  <a
                                    href="mbbs-in-egypt/cairo-university"
