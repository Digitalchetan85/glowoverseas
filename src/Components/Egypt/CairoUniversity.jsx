                    ...
                    <div className="col-md-8">
                      <div className="university">
                        <p className="text-justify pb-2">
                          Cairo University Faculty of Medicine one of the top
                          Medical University in Egypt.
                        </p>
                        <ul>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-12">
                      <div className="university">
                        ...
                        <p className="text-justify">
                          Study MBBS in Egypt at Cairo University Faculty of
                  ...
                  <div className="row pt-5">
                    <div className="col-md-6">
                      <div className="university">
                        ...
                        <p className="pt-2 pb-2 text-justify">
                          ...
                          food is available or not. In Egypt surely we get
                    ...
                    <div className="col-md-6">
                      <div className="university">
                        ...
                        <p className="pt-2 pb-2 text-justify">
                          In Cairo University Faculty of Medicine provides a
