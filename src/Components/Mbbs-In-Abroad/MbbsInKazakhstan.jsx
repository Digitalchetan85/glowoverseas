                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="pb-2">
                        ...
                        {/* <img
                          src="./images/mbbs-in-Kazakhstan-flag.jpg.png"
                          alt=""
                        ...
                        <p className="pt-3 pb-2 text-justify text-info">
                          <strong>Quick Information Table</strong>
                        </p>
                        ...
                        <h5 className="pt-2 pb-2 text-info">
                    ...
                    <div className="col-md-12">
                      ...
                      <table className="table-bordered mt-3 mb-3">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row">
                              <b>Kazakh National Medical University </b>
                            </th>
                            <td>5</td>
                            <td>1931 </td>
                          </tr>
                          <tr>
                            <th scope="row">
                              <b>South Kazakhstan Medical Academy</b>
                            </th>
                            <td>19</td>
                            <td>1943</td>
                          </tr>
                          <tr>
                            <th scope="row">
                              <b>Karaganda State Medical University </b>
                            </th>
                            <td>24</td>
                            <td>1950</td>
                          </tr>
                          <tr>
                            <th scope="row">
                              <b>Samey State Medical University</b>
                            </th>
                            <td>17</td>
                            <td>1953 </td>
                          </tr>
                      ...
                      <table className="table-bordered mt-3 mb-3">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              Fundamentals of Psychology, Bioorganic Chemistry,
                              Medical Chemistry, Embryology, Human Anatomy,
                              Cytology, Elective Courses, patient Care,
                              Embryology
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>
                              Human Anatomy, Histology, Physiology, Philosophy,
                              Emergency Medicine, Microbiology, Immunology
                            </td>
                          </tr>
                          <tr>
                            <th scope="row">
                          ...
                          <tr>
                            ...
                            <td>
                              Epidemiology, Oncology, Social Medicine, Internal
                              Medicine, Surgery, Medical genetics, Traumatology,
                              Gynaecology, Clinical Immunology, Neurosurgery,
                              Obstetrics, Emergency Medicine, Fundamentals of
                              Stomatology
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>
                              ...
                              medicine, Oncology, Obstetrics, Elective Courses.{" "}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      <table className="table-bordered">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              The course might not get international recognition
                            </td>
                          ...
                          <tr>
                            <td className="text-center">
                              The duration of the course is 5.5 years (4.5 years
                              academics + 1-year internship)
                            </td>
                            <td className="table-info">
                              The duration of the course is 5.5 years (4.5 years
                              academics + 1-year internship) The duration of the
                              course 5, 5.5 or 6 years (including internship)
                            </td>
                          </tr>
                          <tr>
                            <td className="text-center">
                      ...
                      <p className="pt-2 pb-2 text-justify">
                        {" "}
                        Most of the universities, following the Russian System,
                        they follow the Asian Curriculum, the education system
                        is high standard and highly qualified faculties advanced
                        Medical System
                      </p>
                      ...
                      <p className="pt-2 pb-2 text-justify">
                        ...
                        <br />
                        The lowest temperature of January and February is -20 …
                        -23°C .
                      </p>
                      <h5 className="pt-2 pb-2">Religion in Kazakhstan</h5>
                      <p className="pt-2 pb-2 text-justify">
                        Kazakhstan in religious geography lies on the boundaries
                      ...
                      <p className="text-justify">
                        ...
                        <ul className="pt-2">
                          <li>
                            <a href="mbbs-in-kazakhstan/al-farabi-national-medical-university.php">
                              Al-Farabi National Medical University
                            </a>
                          </li>
                          <li>
                            <a href="mbbs-in-kazakhstan/international-medical-school.php">
                              International Medical School
                            </a>
                          </li>
                          <li>
                            <a href="mbbs-in-kazakhstan/jsc-natonal-university.php">
                  ...
                  <div className="row pt-5">
                    <div className="col-md-6">
                      <div className="university-country">
                        ...
                        {/* <img
                          src="./images/mbbs-in-Kazakhstan/medical-universities/al-farabi-kazakh-national-university-faculty-of-medicine-and-health-care.png"
                          alt=""
                          className="img-fluid"
                        /> */}
                        <Image src={Farabi} alt="" className="img-fluid"></Image>
                        <p className="pt-2 pb-2 text-justify">
                          Al-Farabi National Medical University one of the top
                        ...
                        <div className="">
                          ...
                          <a
                            href="/al-farabi-national-medical-university"
                    ...
                    <div className="col-md-6">
                      <div className="university-country">
                        ...
                        {/* <img
                          src="./images/mbbs-in-Kazakhstan/medical-universities/international-medical-school.png"
                          alt=""
                          className="img-fluid"
                        /> */}
                        <Image src={International} alt="" className="img-fluid"></Image>
                        <p className="pt-2 pb-2 text-justify">
                          International Medical School is one of the top Medical
                        ...
                        <div className="">
                          {/* <?php include 'templates/university-book-now.php'  ?> */}
                          <a
                            href="/international-medical-school"
                            className="pt-2 pb-2 btn btn-warning m-2 float-right"
                          >
                            Read more
                          </a>
                  ...
                  <div className="row pt-5">
                    <div className="col-md-6">
                      <div className="university-country">
                        ...
                        {/* <img
                          src="./images/mbbs-in-Kazakhstan/medical-universities/jsc-national-medical-university.png"
                          alt=""
                          className="img-fluid"
                        /> */}
                        <Image src={JSC} alt="" className="img-fluid"></Image>'
                        <p className="pt-2 pb-2 text-justify">
                          JSC National Medical University is one of the top
                          Medical University in Ukraine. Get more details on
                          Fees Structure, Hostel, Indian Food Facility and other
                          uncleared information.
                        </p>
                        <div className="">
                          {/* <?php include 'templates/university-book-now.php'  ?> */}
                          <a
                            href="/jsc-national-medical-university"
                            className="pt-2 pb-2 btn btn-warning m-2 float-right"
                          >
                            Read more
                          </a>
