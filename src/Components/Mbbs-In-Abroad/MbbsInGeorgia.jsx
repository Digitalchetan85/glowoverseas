                    ...
                    <div className="col-md-12">
                      <div className="pb-2">
                        ...
                        <p className="text-justify">
                          ...
                          archaic period, arriving at its stature between the
                          tenth and thirteenth hundred of years. After an
                          extensive Turkish and Persian mastery stretch, Georgia
                          was attacked by the Russian Empire in the nineteenth
                          century. A free Georgian state existed from 1918 to
                          1921, when One joined it into the Soviet Union. In
                          1936 Georgia turned into a constituent (association)
                          republic and proceeded as such until the breakdown of
                          the Soviet Union. During the Soviet time frame, the
                          Georgian economy was modernized and broadened. Perhaps
                          the most freedom disapproved of republics, Georgia
                        ...
                        <p className="text-justify">
                          ...
                          Capital and largest city of Georgia is known as
                          Tbilisi. Studying MBBS from Georgia has become one of
                          the popular destinations for Indian students. A
                          medical degree from Georgia is economical as medical
                          universities have quite affordable fees. In addition,
                          the MBBS degree from Georgia is recognized by Medical
                          Council of India (MCI) and also the World Health
                          Organization (WHO). Admission from Georgian
                          universities is quite easy and involves a very simple
                          process. Tbilisi is considered to be the best place
                          for studying MBBS in Georgia as it has achieved 100%
                          of literacy. Living in Georgia is safe – Georgia is
                          the 4th safest country in the world. There are many
                        ...
                        <p className="text-justify">
                          ...
                          capital, Tbilisi, is known for the diverse
                          architecture and maze-like, cobblestone streets of its
                          old town. Also has become a hot destination for Indian
                        ...
                        <p className="text-justify">
                          <ul>
                            ...
                            <li>
                              ...
                              internships since Georgia medical college gives
                              low maintenance occupations. You need to apply for
                              that.
                            </li>
                            <li>
                        ...
                        <p className="pb-2 text-justify">
                          It is not an easy decision for the students and
                          parents in abroad at low cost most of the time, it is
                          dream of the students but the parents are not aware of
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="pt-1 pb-1">
                          ...
                          <p className="text-white">
                            Georgia in religious geography lies on the
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <p className="pb-3 text-justify">
                        Students will be covering the following Subjects while
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="px-2">
                              ...
                              MBBS degree is awarded to medical graduates who
                              have successfully completed the MBBS course
                            </td>
                          </tr>
                      ...
                      <p className="pt-2 pb-2 text-justify">
                        ...
                        tend to be the driest. The average high temperatures are
                        in the warm 78°F (25.6°C) to the hot range of 87°F
                        (30.6°C), while the average low temperatures are in the
                        comfortable range of 61°F (16.1°C) to 71°F (21.7°C).
                      </p>
                    </div>
                  </div>
                </div>
