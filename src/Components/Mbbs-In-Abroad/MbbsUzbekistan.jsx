                    ...
                    <div className="col-md-12">
                      <div className="pb-2">
                        ...
                        <p className="text-justify">
                          MBBS in the Uzbekistan is the dream of every Indian
                          student who wants to pursue their medical career in
                          the Uzbekistan after education. An MBBS is one of the
                          long-term programs offered in the Uzbekistan and the
                          process is very different for international students.
                          They do not take a considerable number of students
                          like other countries do but take the best students
                          from among the crowd. The difficulty level of the MCAT
                          exam gives an insight into the rigorous approach
                          followed for an admission in the Uzbekistan for MBBS.
                          More than 3000 students keep their first choice as the
                          Uzbekistan, but only 0.1% of them get the chance to
                          get admission. The admission process depends on the
                          criteria of the board, universities, and the entrance
                          test.
                        </p>
                        <p className="text-justify">
                          ...
                          top medical college in the Uzbekistan, you need more
                          than a 500 score on MCAT.
                        </p>
                        <p className="text-justify">
                          <b>Via the Caribbean – </b>This roadmap is quite
                          famous in India. Many aspirants select the MD program
                          of the Uzbekistan via the Caribbean Islands. It is one
                          of the cheapest ways. It costs almost 70 to 80 lakhs.
                        ...
                        <p className="text-justify">
                          <b>WHY STUDY MBBS IN Uzbekistan?</b>
                          <ol>
                            <li>
                            ...
                            <li>
                              The cost of MBBS + PG in the Uzbekistan is the
                              same as compared to the Indian private college
                              MBBS program.
                            </li>
                            <li>
                        ...
                        <h2 className="text-info pt-2 pb-2">
                          Advantages of Studying in Uzbekistan
                        </h2>
                        <p className="text-justify">
                          <ul>
                            <li>
                            ...
                            <li>
                              The diversity of students in the Uzbekistan allows
                              them to familiarize themselves with the culture
                              and customs of other places.
                            </li>
                            <li>
                            ...
                            <li>
                              International students can study MBBS in the
                              Uzbekistan with great confidence, and this
                              certainly provides a great deal of relief to the
                              students.
                            </li>
                            <li>
                            ...
                            <li>
                              MBBS in the Uzbekistan includes three phases,
                              including Clinical Rotations. Clinical rotations
                              allow students to gain clinical experience at some
                              of the finest hospitals in the US and abroad,
                              assist doctors, and be a part of patient care
                            ...
                            <li>
                              ...
                              pursuing MBBS in the Uzbekistan are offered good
                              facilities.
                            </li>
                          </ul>
                        </p>
                        <p className="pt-3 pb-3 text-justify text-info">
                          <strong>
                            Quick Information About MBBS In Uzbekistan
                          </strong>
                        </p>
