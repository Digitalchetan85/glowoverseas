                          ...
                          <div className="row">
                            <div className="col-md-6">
                              <div className="university">
                                ...
                                <p className="pt-2 pb-2 text-justify text-center">
                                  Grodno State Medical University is one of the
                                  top Medical University in Belarus. Get more
                            ...
                            <div className="col-md-6">
                              <div className="university">
                                ...
                                />
                                <p className="pt-2 pb-2 text-justify text-center">
                                  Belarusian State Medical University is one of
                                  the top Medical University in Ukraine. Get
                                  more details on Fees Structure, Hostel, Indian
                                  Food Facility and other uncleared
                                  information..
                                </p>
                                <div className="">
                                  {/* <?php include '../templates/university-book-now.php'  ?> */}
                                  <a
                                    href="mbbs-in-belarus/belarusian-state-medical-university"
                                    className="pt-2 pb-2 btn btn-warning m-2 float-right"
                                  >
                                    Read more
                                  </a>
